...
export default function Home() {
  return (
    <div className='h-[90vh] grid grid-cols-2'>
      <a href="/[theme]/test" className='h-full relative bg-gray-100 border-r-3 border-blue-50 flex justify-center items-center flex-col group hover:bg-transparent'>
      ...
      <a href="/[theme]/test" className='h-full relative bg-gray-100 border-l-3 border-blue-50 flex justify-center items-center flex-col group hover:bg-transparent'>
